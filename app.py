...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Trung Hiếu - Trường PTDTBT Tiểu học Yên Cường - ĐT: 0869228994</p>
</div>
""", unsafe_allow_html=True)
...
c1, c2 = st.columns(2)
with c1: lop = st.text_input("📚 Lớp:", "Lớp:")
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Trung Hiếu - Trường PTDTBT Tiểu học Yên Cường - ĐT: 0869228994</div>", unsafe_allow_html=True)
